...
List<Product> listOfProducts = [
  Product(
    ...
    features: "Tela 6,7* Câm. Quádrupla Câm. + Selfie 32MP",
    price: 1979.97,
    price_description: "10x de R\$ 212,90 sem juros",
    isFavorite: true,
  ),
  Product(
    photo: "assets/images/geladeira.jpg",
    name: "Geladeira Brastemp Frost Free Duplex Evox",
    features: "375L BRM45 HKANA",
    price: 2698,
    price_description: "10x de R\$ 269,80 sem juros",
  ),
  Product(
    photo: "assets/images/fritadeira.jpg",
    name: "Fritadeira Elétrica sem Óleo/Air Fryer Nell Smart",
    features: "Preta 2,4L com Timer",
    price: 229.90,
    price_description: "5x de R\$ 45,98 sem juros",
  ),
  Product(
    photo: "assets/images/computador.jpg",
    name: "PC Gamer Neologic Start NLI81426 RYZEN 3 2200G 8GB",
    features: "Radeon Vega 8 Integrado + SSD 240GB",
    price: 4859,
    price_description: "12x de R\$ 404,92 sem juros",
    isFavorite: true,
  ),
  Product(
    ...
    features: "Redshock",
    price: 99.90,
    price_description: "3x de R\$ 33,30 sem juros",
  ),
  Product(
    photo: "assets/images/ventilador.jpg",
    name: "Ventilador de Parede e Mesa Mondial Maxi Power",
    features: "NV-15-6P-FB 30cm 3 Velocidades",
    price: 89.90,
    price_description: "2x de R\$ 44,95 sem juros",
    isFavorite: true,
  ),
  Product(
    photo: "assets/images/drone.jpg",
    name: "Drone Multilaser Eagle FPV",
    features: "Câmera HD Flips 360",
    price: 1979.97,
    price_description: "10x de R\$ 212,90 sem juros",
  ),
];
